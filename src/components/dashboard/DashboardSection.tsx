...
export const ExpandableSlot = forwardRef<HTMLButtonElement, ExpandableSlotProps>(
  function ExpandableSlot({ title, description, icon, comingSoon = true, onPress }, ref) {
    return (
      <motion.button
        ref={ref}
        whileTap={{ scale: 0.98 }}
